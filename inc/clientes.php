        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input data-requerido="true" id="giro_cliente" class="form-control" type="text"
                           placeholder="Giro">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input data-requerido="true" id="ruc_cliente" class="form-control" type="text" placeholder="RUC">
                </div>
                <div class="form-group">
