    ...
    <div class="row">
        <div class="col-xs-12 col-md-4" id="contenedor_formulario">
            ...
            <div class="form-group">
                ...
                <input data-requerido="true" class="form-control" type="text" id="proveedor"
...
<div id="modal_agregar_piezas" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Agregar mercaderia</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label for="numero_piezas_agregar">Ingresa la cantidad de mercaderia que quieres agregar</label>
                    <input class="form-control" placeholder="Ingresa la cantidad de mercaderia que quieres agregar"
...
<div id="modal_dar_baja" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="numero_piezas_baja">Ingresa la cantidad de mercaderia que quieres dar de baja</label>
                    <input class="form-control" placeholder="Ingresa la cantidad de mercaderia que quieres dar de baja"
